  ...
  return (
    ...
    >
      ...
      <div
        ...
        `}
      >
        {Object.values(filterStore).map((filter) => (
          <FilterPicker
            key={filter.title}
            type={filter}
...
const Products = () => {
  ...
  return (
    <div className="flex flex-col justify-between h-full py-12">
      ...
      <div className="gap-5 sm:flex-row max-sm:flex flex-col sm:grid grid-cols-4">
        ...
        <div className="text-neutral-800/50 dark:text-neutral-100/50 w-full flex justify-end ">
  ...
  return (
    <div className="flex flex-col justify-between h-full py-12">
      ...
      <div className="gap-5 sm:flex-row max-sm:flex flex-col sm:grid grid-cols-4">
        ...
        <div className="text-neutral-800/50 dark:text-neutral-100/50 flex w-full justify-end ">
          <span className="font-bold"> 
            Total:
          </span>
  ...
  return (
    <div className={`grid grid-cols-2 gap-6 ${className}`}>
      <CardContainer className="max-md:col-span-2" title="Total Customers">
        <div className="flex md:justify-between items-start ">
          <div>
            <Triangle
            ...
            />
            <p className="text-4xl lg:text-3xl xl:text-4xl font-bold mt-2 text-neutral-800 dark:text-neutral-100">
              2,4%
            </p>
            <p className="text-sm mt-2 text-neutral-600 dark:text-neutral-400">
              <span className="font-bold">Web Surfing</span>
            </p>
          </div>
          <div className="ml-6">
            <Triangle
            ...
            <p className="text-sm mt-2 text-neutral-600 dark:text-neutral-400">
              <span className="font-bold">Radio Station</span>
            </p>
          </div>
        </div>
              ...
              <div className="w-full px-8 flex justify-between items-center">
                ...
                <div className="max-md:hidden md:pl-16 flex items-start">
                  {navButtons.map((button,index) => (
                    <NavButton
                      key={index.toString()+button.title?.replaceAll(" ", "-")}
                      title={button.title}
                      icon={button.icon}
